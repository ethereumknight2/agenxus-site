...
const CarDealershipAILanding = () => {
  const brand = 'Agenxus';
  const phoneNumber = '+15551233366';
  const phoneDisplay = '(555) 123-DEMO';
  const bookUrl = 'https://cal.com/your-handle/10min';
  const webhookUrl = 'https://YOUR-N8N-ENDPOINT/webhook/lead';
  
  // Dynamic logo path that works in dev and production
  const logoPath = `${import.meta.env.BASE_URL}logo.png`;
  
  // Removed unused pricing object

  const pricingBlurb = "Get a custom AI solution built for your dealership and budget • Pilot in 48 hours • 14-day risk-free • Cancel anytime";
  const specificityLine = "After-hours & overflow on day 1. Live inventory, payments, and service booking by day 2.";
  
  // Remove unused isVisible state since we're not using the animation observer
  const [showVideo, setShowVideo] = useState(false);

  // Simplified useEffect - removed unused intersection observer
  useEffect(() => {
  ...
  const testimonials = [
    {
      quote: "Our customers love how quickly they get answers about inventory and pricing. The AI handles payment calculations instantly and routes calls perfectly to the right department.",
    },
    {
      quote: "Service appointment booking has never been smoother. The SMS reminders cut our no-shows by 60% and customers appreciate the streamlined experience.",
    },
    {
      quote: "This system improved our entire customer experience. Whether it's sales, service, or just general questions, every caller gets professional, knowledgeable assistance.",
    }
  ];
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "offers": {
              "@type": "Offer",
              "description": "Custom AI voice agent solutions for car dealerships"
            }
          })
        }}
      />
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div className="h-12 w-auto" style={{ display: 'none' }}>
                ...
                >
                  ...
                  <text x="44" y="20" fontFamily="system-ui, -apple-system, sans-serif" fontSize="16" fontWeight="700" fill="url(#logoGradient)">
                    {brand}
                  </text>
                  <text x="44" y="34" fontFamily="system-ui, -apple-system, sans-serif" fontSize="10" fontWeight="400" fill="#9CA3AF">
                    AI Voice Solutions
                  </text>
                </svg>
              </div>
            ...
            <a
              ...
              onClick={() => window.gtag?.('event', 'click_book_demo', { location: 'header' })}
            >
              Book Demo
            </a>
          </div>
        ...
        <div className="container mx-auto text-center">
          <main>
            ...
            <p className="text-lg text-purple-300 mb-4 font-medium">
              Missed calls ≠ missed revenue. Capture after-hours Sales & Service automatically.
            </p>
            <p className="text-xl text-gray-300 mb-4 max-w-4xl mx-auto leading-relaxed">
              Answer every Sales & Service call, route intelligently, book on the spot, and send SMS reminders.
            </p>
            <p className="text-base text-gray-300 mt-2 mb-8 max-w-3xl mx-auto">
              For franchise & independent dealerships that want fewer missed calls, faster speed-to-lead, and lower no-shows—without adding headcount.
            </p>
            ...
            <div className="mb-8 text-center">
              ...
              <p className="text-gray-300 mb-4">Sales or Service? The AI routes you.</p>
              <a 
                ...
                onClick={() => window.gtag?.('event', 'click_call_ai', { location: 'hero' })}
              >
                <PhoneCall className="w-8 h-8" />
                <span>{phoneDisplay}</span>
              </a>
              <div className="mt-3 text-sm text-gray-400">{pricingBlurb}</div>
              <div className="mt-2 text-sm text-purple-300">{specificityLine}</div>
              <div className="mt-2 text-xs text-gray-500">If you're not seeing value in 14 days, cancel—no questions asked.</div>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center items-center mb-8">
              <a 
                ...
                onClick={() => window.gtag?.('event', 'click_book_demo', { location: 'hero' })}
              >
            ...
            <p className="text-xs text-gray-500 text-center mb-8">We won't spam you. Opt-out anytime.</p>
          </main>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-6">
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
              <h3 className="font-semibold text-white mb-2">Can it use our live inventory and incentives?</h3>
              <p className="text-gray-300">Yes. We connect to your inventory feed and import current incentives so callers get accurate, on-brand answers.</p>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
              <h3 className="font-semibold text-white mb-2">How are payments calculated?</h3>
              <p className="text-gray-300">We apply your finance parameters (APR, term, down payment, trade-in) and display estimates with clear disclaimers.</p>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
              <h3 className="font-semibold text-white mb-2">Does this replace our receptionist?</h3>
              <p className="text-gray-300">
                It can, or it can serve simply as after-hours and overflow coverage—the choice is yours depending on your needs. Most dealerships start with <strong>after-hours and overflow</strong> coverage, then decide whether to expand to full-time coverage. You control routing rules, escalation to humans, and hours of operation.
              </p>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
              <h3 className="font-semibold text-white mb-2">How do handoffs to humans work?</h3>
              <p className="text-gray-300">
                The AI can warm-transfer to extensions or cell phones, create call-back tasks, and send transcripts to your CRM. You decide when to escalate—by intent, sentiment, or wait time.
              </p>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
              <h3 className="font-semibold text-white mb-2">Where does our data live?</h3>
              <p className="text-gray-300">
                Your CRM and inventory data stays in your systems. We store call metadata and model prompts for quality only, following dealership policies. PII redaction and data retention windows are configurable.
              </p>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
              <h3 className="font-semibold text-white mb-2">What are our rollout options?</h3>
              <p className="text-gray-300">
                Choose a fully managed subscription, a one-time setup with a light service plan, or an enterprise rollout across multiple rooftops. We scope to your budget and systems.
              </p>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
              <h3 className="font-semibold text-white mb-2">What if we're not happy?</h3>
              <p className="text-gray-300">Start with a 14-day pilot. If it's not a fit, cancel—no questions asked.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <form
              ...
              onSubmit={async (e) => {
                ...
                try {
                  ...
                  window.gtag?.('event', 'submit_lead', { location: 'lead_section' });
            ...
            >
              ...
              <p className="text-sm text-gray-400 mt-3 text-center">We only use your email to send the walkthrough. No resale. Data stays in your systems; we log metadata only.</p>
            </form>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              One AI system that works like <span className="text-purple-400 font-bold">three expert employees</span> — Receptionist, Sales Specialist, and Service Coordinator.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-7xl mx-auto">
            ...
            <div className="group bg-white/5 backdrop-blur-sm rounded-xl p-8 border border-white/10 hover:border-purple-500/50 transition-all duration-300 transform hover:scale-105 hover:bg-white/10">
              ...
              <p className="text-sm text-purple-300 mb-4 font-medium">Fewer missed calls</p>
            ...
            <div className="group bg-white/5 backdrop-blur-sm rounded-xl p-8 border border-white/10 hover:border-blue-500/50 transition-all duration-300 transform hover:scale-105 hover:bg-white/10">
              ...
              <p className="text-sm text-blue-300 mb-4 font-medium">Faster speed-to-lead</p>
              <ul className="space-y-3 text-gray-400 group-hover:text-gray-300 transition-colors">
                <li className="flex items-start space-x-3">
                  <CheckCircle className="w-5 h-5 text-green-400 flex-shrink-0 mt-0.5" />
                  <span>Searches <strong>live new & used inventory</strong></span>
                </li>
                <li className="flex items-start space-x-3">
                  <CheckCircle className="w-5 h-5 text-green-400 flex-shrink-0 mt-0.5" />
            ...
            <div className="group bg-white/5 backdrop-blur-sm rounded-xl p-8 border border-white/10 hover:border-cyan-500/50 transition-all duration-300 transform hover:scale-105 hover:bg-white/10">
              ...
              <p className="text-sm text-cyan-300 mb-4 font-medium">Lower no-shows</p>
              <ul className="space-y-3 text-gray-400 group-hover:text-gray-300 transition-colors">
                <li className="flex items-start space-x-3">
                  <CheckCircle className="w-5 h-5 text-green-400 flex-shrink-0 mt-0.5" />
          ...
          <p className="text-sm text-gray-400 text-center mt-8">
            Works with: vAuto • CDK • Dealertrack • Cal.com/Calendly • Twilio SMS
          </p>
          <p className="text-sm text-gray-400 text-center mt-6">
            Admin controls include: routing & hours, banned phrases, escalation rules, transcript export, and opt-out keywords.
          </p>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-gradient-to-r from-purple-600/20 to-blue-600/20 backdrop-blur-sm rounded-xl p-8 border border-purple-500/30">
              <p className="text-xl text-gray-200 leading-relaxed">
                This AI is trained specifically for <span className="text-purple-400 font-bold">dealership operations</span>. It integrates with your <span className="text-blue-400 font-bold">CRM, inventory, and scheduling systems</span> <em className="text-gray-300">read-only or write-back as approved</em> so customers get <span className="text-cyan-400 font-bold">accurate, helpful, and on-brand interactions every time</span>.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">Dial <a href={`tel:${phoneNumber}`} className="underline decoration-dotted">{phoneDisplay}</a></p>
                      <p className="text-xs text-gray-500 mt-1">Demo line records for quality. Do not share sensitive info.</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">Book service, check inventory, request payments</p>
                      <p className="text-xs text-gray-400 mt-1">Ask for a payment on a specific VIN, or reschedule a service appointment—just like a customer would.</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">How it feels for your customers</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a 
                  ...
                  onClick={() => window.gtag?.('event', 'click_call_ai', { location: 'demo_section' })}
                >
                ...
                <a 
                  ...
                  onClick={() => window.gtag?.('event', 'click_book_demo', { location: 'demo_section' })}
                >
                  <Calendar className="w-5 h-5" />
                  <span>Book Demo</span>
                </a>
            ...
            <div className="relative">
              <div className="bg-gradient-to-r from-purple-500/20 to-blue-500/20 backdrop-blur-sm rounded-xl p-8 border border-white/20">
                ...
                <div className="mt-4 text-center">
                  <h4 className="text-lg font-semibold mb-2">Watch Full Demo</h4>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-8 max-w-6xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-gray-400">Subscription, setup+service, or enterprise—designed for your budget</p>
            </div>
            <div className="text-center">
      ...
      <section className="py-20 px-6 bg-gradient-to-r from-purple-900/50 to-blue-900/50">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-4xl mx-auto">
            Book your <span className="text-purple-400 font-semibold">free demo</span> now and see how much business you've been leaving on the table.
          </p>
          ...
          <div className="flex flex-col md:flex-row gap-6 justify-center items-center">
            <a 
              ...
              onClick={() => window.gtag?.('event', 'click_book_demo', { location: 'footer' })}
            >
            ...
            <a 
              ...
              onClick={() => window.gtag?.('event', 'click_call_ai', { location: 'footer' })}
            >
          ...
          <div className="mt-12 text-center">
            <p className="text-gray-400 mb-4">🎯 Flexible launch plans • 📞 14-day risk-free pilot • ⚡ Go live in 48 hours</p>
      ...
      <div className="md:hidden fixed bottom-0 inset-x-0 z-50 bg-black/90 backdrop-blur border-t border-white/10">
        <div className="p-3 flex gap-3">
          <a 
            ...
            onClick={() => window.gtag?.('event', 'click_call_ai', { location: 'sticky_mobile' })}
          >
          ...
          <a 
            ...
            onClick={() => window.gtag?.('event', 'click_book_demo', { location: 'sticky_mobile' })}
          >
        ...
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center space-x-3 mb-4 md:mb-0">
              ...
              <div className="h-8 w-auto" style={{ display: 'none' }}>
                ...
                >
                  ...
                  <circle cx="12" cy="16" r="10" fill="url(#footerLogoGradient)" />
                  <path d="M8 13h8v6H8z" fill="white" />
                  <circle cx="9.5" cy="14.5" r="1" fill="#8B5CF6" />
                  <circle cx="14.5" cy="17.5" r="1" fill="#8B5CF6" />
                  
                  <text x="28" y="14" fontFamily="system-ui, -apple-system, sans-serif" fontSize="12" fontWeight="700" fill="url(#footerLogoGradient)">
                    {brand}
                  </text>
                  <text x="28" y="22" fontFamily="system-ui, -apple-system, sans-serif" fontSize="8" fontWeight="400" fill="#9CA3AF">
            ...
            <div className="flex space-x-6 text-gray-400">
              <a href="/privacy" className="hover:text-white transition-colors" rel="noopener noreferrer">Privacy Policy</a>
              <a href="/terms" className="hover:text-white transition-colors" rel="noopener noreferrer">Terms of Service</a>
              <a href="/support" className="hover:text-white transition-colors" rel="noopener noreferrer">Support</a>
            </div>
          </div>
          
          <div className="mt-8 pt-8 border-t border-white/10 text-center text-gray-400">
            <p>&copy; 2025 {brand}. All rights reserved. Transform your dealership with AI voice technology.</p>
            <p className="text-xs mt-2 text-gray-500">No flat tiers. No cookie-cutter pricing. Every dealership is different — so is our plan for you.</p>
          </div>
        </div>
      </footer>
